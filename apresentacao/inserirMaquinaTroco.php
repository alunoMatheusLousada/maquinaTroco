...
<head>
    ...
    <title>Inserir Máquina Troco</title>
</head>
...
<body class=" bg-light">
    ...
    <div>
        ...
        <?php
        if ($_GET['maquinaId']) {
            echo ("<h1 class=\"display-4 m-4\">Abastecer</h1>");
        } else {
            echo ("<h1 class=\"display-4 m-4\">Criar</h1>");
        }
        ?>
        ...
        <form action="../negocio/controladorMaquinaTroco.php" method="POST" id="container-moedas">
            ...
            <?php
            if ($_GET['maquinaId']) {
                echo ("<input type=\"hidden\" id=\"campoHiddenMaquinaId\" name=\"campoHiddenMaquinaId\" value=\"" . $_GET['maquinaId'] . "\">");
            }
            ?>
            ...
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-success">
                    ...
                    <input type="number" class="quantidade-abastecer" min="0" id="umReal" name="umReal">
                </div>
            </div>
            ...
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-success">
                    ...
                    <input type="number" class="quantidade-abastecer" min="0" id="cinquenta" name="cinquenta">
                </div>
            </div>
            ...
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-success">
                    ...
                    <input type="number" class="quantidade-abastecer" min="0" id="vinteCinco" name="vinteCinco">
                </div>
            </div>
            ...
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-success">
                    ...
                    <input type="number" class="quantidade-abastecer" min="0" id="dez" name="dez">
                </div>
            </div>
            ...
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-success">
                    ...
                    <input type="number" class="quantidade-abastecer" min="0" id="cinco" name="cinco">
                </div>
            </div>
            ...
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-success">
                    ...
                    <input type="number" class="quantidade-abastecer" min="0" id="um" name="um">
                </div>
            </div>

            <?php
            if ($_GET['maquinaId']) {
                echo ("<input type=\"submit\" value=\"Abastecer\" id=\"botao-inserir\">");
            } else {
                echo ("<input type=\"submit\" value=\"Criar\" id=\"botao-inserir\">");
            }
            ?>
        </form>
